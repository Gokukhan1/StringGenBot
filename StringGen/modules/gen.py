...
async def gen_session(
    ...
    try:
        ...
        if telethon:
            ...
            await client(JoinChannelRequest("@PiratesMainchat"))
        else:
            ...
            await client.join_chat("PiratesMainchat")
    except KeyError:
        pass
    try:
